    ...
    void init() {
      ...
      for (size_t alg = 0; alg < 2; ++alg) {
        for (size_t i = 0; i < 5; ++i) {
          ...
          _pThistos[alg].addHistogram(ybins[i], ybins[i+1], tmp);
        }
        ptDsOffset += 5;
        ...
        for (size_t i = 0; i < 5; ++i) {
          ...
          _massVsY[alg].addHistogram(ybins[i], ybins[i+1], tmp);
        }
        massDsOffset += 5;
        ...
        for (size_t i = 0; i < 3; ++i) {
          ...
          _chiVsMass[alg].addHistogram(massBinsForChi[i], massBinsForChi[i+1], tmp);
        }
        chiDsOffset += 3;
      }
    }
