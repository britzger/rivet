...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      {Histo1DPtr tmp; _binnedHistosR07.addHistogram(  0, 0.1, book(tmp, 1, 1, 1));}
      {Histo1DPtr tmp; _binnedHistosR07.addHistogram(0.1, 0.7, book(tmp, 2, 1, 1));}
      {Histo1DPtr tmp; _binnedHistosR07.addHistogram(0.7, 1.1, book(tmp, 3, 1, 1));}
      {Histo1DPtr tmp; _binnedHistosR07.addHistogram(1.1, 1.6, book(tmp, 4, 1, 1));}
      {Histo1DPtr tmp; _binnedHistosR07.addHistogram(1.6, 2.1, book(tmp, 5, 1, 1));}
