...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      {Histo1DPtr tmp; _h_chMult.add( 6.5,  7.5, book(tmp, 1,1,3));}
      {Histo1DPtr tmp; _h_chMult.add( 7.5,  9.5, book(tmp, 2,1,1));}
      {Histo1DPtr tmp; _h_chMult.add( 9.5, 13.0, book(tmp, 2,1,2));}
      {Histo1DPtr tmp; _h_chMult.add(13.0, 16.0, book(tmp, 3,1,1));}
      {Histo1DPtr tmp; _h_chMult.add(16.0, 20.0, book(tmp, 3,1,2));}

      {Histo1DPtr tmp; _h_chFragFunc.add(13.0, 16.0, book(tmp, 5,1,1));}
      {Histo1DPtr tmp; _h_chFragFunc.add(16.0, 20.0, book(tmp, 5,1,2));}
  ...
  private:
    ...
    /// @name Histograms
    //@{
    BinnedHistogram _h_chMult;
    BinnedHistogram _h_chFragFunc;
    //@}
