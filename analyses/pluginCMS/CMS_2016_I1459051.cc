...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      // AK7
      {Histo1DPtr tmp; _hist_sigmaAK7.addHistogram(0.0, 0.5, book(tmp, 1, 1, 1));}
      {Histo1DPtr tmp; _hist_sigmaAK7.addHistogram(0.5, 1.0, book(tmp, 2, 1, 1));}
      {Histo1DPtr tmp; _hist_sigmaAK7.addHistogram(1.0, 1.5, book(tmp, 3, 1, 1));}
      {Histo1DPtr tmp; _hist_sigmaAK7.addHistogram(1.5, 2.0, book(tmp, 4, 1, 1));}
      {Histo1DPtr tmp; _hist_sigmaAK7.addHistogram(2.0, 2.5, book(tmp, 5, 1, 1));}
      {Histo1DPtr tmp; _hist_sigmaAK7.addHistogram(2.5, 3.0, book(tmp, 6, 1, 1));}
      book(_hist_sigmaAK7Forward, 7, 1, 1);
      // AK4
      {Histo1DPtr tmp; _hist_sigmaAK4.addHistogram(0.0, 0.5, book(tmp, 8, 1, 1));}
      {Histo1DPtr tmp; _hist_sigmaAK4.addHistogram(0.5, 1.0, book(tmp, 9, 1, 1));}
      {Histo1DPtr tmp; _hist_sigmaAK4.addHistogram(1.0, 1.5, book(tmp, 10, 1, 1));}
      {Histo1DPtr tmp; _hist_sigmaAK4.addHistogram(1.5, 2.0, book(tmp, 11, 1, 1));}
      {Histo1DPtr tmp; _hist_sigmaAK4.addHistogram(2.0, 2.5, book(tmp, 12, 1, 1));}
      {Histo1DPtr tmp; _hist_sigmaAK4.addHistogram(2.5, 3.0, book(tmp, 13, 1, 1));}
