...
Title=$\Delta \phi$ between the dijet and diphoton, $N_{jets} \ge 2$, $p_T^{jet} > 30$ GeV
...
Title=the dijet invariant mass,  $N_{jet} \ge 2$, $p_T^{jet} > 30$ GeV
XLabel=$m_{jj}$ [GeV] 
...
Title=the diphoton transverse momentum, $N_{jet} = 0$
XLabel=$p_T^{\gamma\gamma}$ [GeV]
...
Title=the diphoton transverse momentum, $N_{jet} = 1$
XLabel=$p_T^{\gamma\gamma}$ [GeV]
YLabel=$\mathrm{d}\sigma_{\mathrm{fid}} / \mathrm{d} p_T^{\gamma\gamma}$ [fb/GeV]
LogY=0
# END PLOT
...
Title=the diphoton transverse momentum, $N_{jet} \ge 2$
XLabel=$p_T^{\gamma\gamma}$ [GeV]
YLabel=$\mathrm{d}\sigma_{\mathrm{fid}} / \mathrm{d} p_T^{\gamma\gamma}$ [fb/GeV]
LogY=0
# END PLOT
...
Title=the leading jet transverse momentum, $N_{jet} = 1$
XLabel=$p_T^{j1}$ [GeV]
