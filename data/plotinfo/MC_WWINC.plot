...
# BEGIN PLOT /MC_WWJETS/WW_pT_peak
...
# BEGIN PLOT /MC_WWJETS/Wl_eta
Title=Lepton $\eta$
XLabel=$\eta_{\text{l}}$
YLabel=$\text{d}\sigma/\text{d}\eta_{\text{l}}$ [pb]
# END PLOT

# BEGIN PLOT /MC_WWJETS/WeWm_dphi
