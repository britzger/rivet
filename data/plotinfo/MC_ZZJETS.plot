...
# BEGIN PLOT /MC_ZZJETS/ZZ_pT_peak
...
# BEGIN PLOT /MC_ZZJETS/ZZ_costheta_planes
Title=Angle between the boson decay planes
XLabel=$\cos(\Psi_{\text{ee},\mu\mu})$
YLabel=$\text{d}\sigma/\text{d}\cos(\Psi_{\text{ee},\mu\mu})$ [pb]
# END PLOT

# BEGIN PLOT /MC_ZZJETS/Z_pT
Title=Z $p_\perp$
...
# BEGIN PLOT /MC_ZZJETS/Zl_eta
Title=Lepton $\eta$
XLabel=$\eta_{\text{l}}$
YLabel=$\text{d}\sigma/\text{d}\eta_{\text{l}}$ [pb]
# END PLOT

# BEGIN PLOT /MC_ZZJETS/ZeZm_dphi
...
# BEGIN PLOT /MC_ZZJETS/ZeZm_deta
