...
namespace Rivet {
  ...
  /// \f[ S^{\alpha \beta} = \frac{\sum_i p_i^\alpha p_i^\beta}{\sum_i |\mathbf{p}_i|^2} \f],
  ...
  /// the sphericity is
  /// \f[ S = \frac{3}{2} (\lambda_2 + \lambda_3) \f].
  ///
  ...
  /// \f[ S^{\alpha \beta} = \frac{\sum_i |\mathbf{p}_i|^{r-2} \sum_i p_i^\alpha p_i^\beta}{\sum_i |\mathbf{p}_i|^r} \f].
  ///
