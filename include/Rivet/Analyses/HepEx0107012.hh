// -*- C++ -*-
#ifndef RIVET_HepEx0107012_HH
#define RIVET_HepEx0107012_HH
...
namespace Rivet {  
  ...
  class HepEx0107012 : public Analysis {
  ...
  public:
    ...
    /// Factory method
    static Analysis* create() { return new HepEx0107012(); }
  ...
  private:
    ...
    HepEx0107012& operator=(const HepEx0107012& x);
