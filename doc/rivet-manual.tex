...
\usepackage{xspace,graphicx,mparhack,amsmath,amssymb,url,underscore}
%\usepackage{dropping}
...
and build them in the right order. You can get this script from the following
Web address: \url{http://www.hepforge.org/downloads/rivet/rivet-bootstrap}
...
\var{PATH} environment variable and \kbd{\val{localdir}/lib} to your \var{LD_LIBRARY_PATH}.
