...
const string toString(const Vector3& v3) {
  ostringstream out("(");
  out << "("  << v3[0] 
      << ", " << v3[1]
      << ", " << v3[2] << ")";
...
std::ostream& operator<<(std::ostream& out, const Vector3& v3) {
  out << toString(v3);
  return out;
}

const string toString(const Vector4& v4) {
  ostringstream out("(");
  out << "("  << v4[0] 
      << "; " << v4[1]
      << ", " << v4[2]
...
std::ostream& operator<<(std::ostream& out, const Vector4& v4) {
  out << toString(v4);
  return out;
}
