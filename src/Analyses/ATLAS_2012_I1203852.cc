...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      vector<pair<double, double> > etaRanges_lep;
      etaRanges_lep.push_back(make_pair(-3.16, 3.16));
      ...
      DressedLeptons electron_sel4l(Photon, bare_EL, 0.1, true/*Do clustering*/,
                                    etaRanges_lep, 7*GeV, false/*false = ignore photons from hadron or tau*/);
      addProjection(electron_sel4l, "ELECTRON_sel4l");
      DressedLeptons muon_sel4l(Photon, bare_MU, 0.1,true, etaRanges_lep, 7*GeV, false);
      addProjection(muon_sel4l, "MUON_sel4l");


      // Selection 2: ZZ-> llnunu selection
      vector<pair<double, double> > etaRanges_lep2;
      etaRanges_lep2.push_back(make_pair(-2.5, 2.5));
      DressedLeptons electron_sel2l2nu(Photon, bare_EL, 0.1,true, etaRanges_lep2, 10*GeV, false);
      addProjection(electron_sel2l2nu, "ELECTRON_sel2l2nu");
      DressedLeptons muon_sel2l2nu(Photon, bare_MU, 0.1,true, etaRanges_lep2, 10*GeV, false);
