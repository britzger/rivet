...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      // Eta ranges
      vector<pair<double, double> > eta_full;
      eta_full.push_back(make_pair(-5.0, 5.0));
      vector<pair<double, double> > eta_lep;
      eta_lep.push_back(make_pair(-2.5, 2.5));

      // All final state particles
      FinalState fs(eta_full, 1.0*MeV);
      ...
      DressedLeptons dressedelectrons(photons, electrons, 0.1, true, eta_lep, 25.0*GeV,true);
      addProjection(dressedelectrons, "dressedelectrons");
      DressedLeptons vetodressedelectrons(photons, electrons, 0.1, true, eta_lep, 15.0*GeV,true);
      addProjection(vetodressedelectrons, "vetodressedelectrons");
      DressedLeptons ewdressedelectrons(photons, electrons, 0.1, true, eta_full, 1.0*MeV,true);
      ...
      DressedLeptons dressedmuons(photons, muons, 0.1, true, eta_lep, 25.0*GeV,true);
      addProjection(dressedmuons, "dressedmuons");
      DressedLeptons vetodressedmuons(photons, muons, 0.1, true, eta_lep, 15.0*GeV,true);
      addProjection(vetodressedmuons, "vetodressedmuons");
      DressedLeptons ewdressedmuons(photons, muons, 0.1, true, eta_full, 1.0*MeV,true);
