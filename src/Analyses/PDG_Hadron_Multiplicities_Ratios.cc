...
namespace Rivet {
  ...
  void PDG_Hadron_Multiplicities_Ratios::init() {
    ...
    _hist10MeanMultiLambda_c_Plus      = bookHistogram1D(51, 1, 1, "Ratio (w.r.t. Pi+/Pi-) of mean  Lambda_c+ multiplicity");
    _hist10MeanMultiSigma_c_PlusPlus_0 = bookHistogram1D(53, 1, 1, "Ratio (w.r.t. Pi+/Pi-) of mean  Sigma_c++, Sigma_c0 multiplicity");
    ...
    _hist32MeanMultiLambda_c_Plus      = bookHistogram1D(51, 1, 2, "Ratio (w.r.t. Pi+/Pi-) of mean  Lambda_c+ multiplicity");
    ...
    _hist91MeanMultiChi_c1_3510        = bookHistogram1D(30, 1, 1, "Ratio (w.r.t. Pi+/Pi-) of mean  chi_c1(3510) multiplicity");
    ...
    _hist91MeanMultiLambda_c_Plus      = bookHistogram1D(51, 1, 3, "Ratio (w.r.t. Pi+/Pi-) of mean  Lambda_c+ multiplicity");
    _hist91MeanMultiLambda_b_0         = bookHistogram1D(52, 1, 1, "Ratio (w.r.t. Pi+/Pi-) of mean  Lambda_b0 multiplicity");
