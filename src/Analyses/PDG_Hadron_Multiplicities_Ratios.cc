...
namespace Rivet {
  ...
  void PDG_HADRON_MULTIPLICITIES_RATIOS::init() {
    _hist10MeanMultiPi0                = bookHistogram1D( 2, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\pi^0$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiKPlus              = bookHistogram1D( 3, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $K^+$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiK0                 = bookHistogram1D( 4, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $K^0$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiEta                = bookHistogram1D( 5, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\eta$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiEtaPrime           = bookHistogram1D( 6, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\eta'(958)$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiDPlus              = bookHistogram1D( 7, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $D^+$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiD0                 = bookHistogram1D( 8, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $D^0$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiDPlus_s            = bookHistogram1D( 9, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $D^+_s$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiF0_980             = bookHistogram1D(13, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $f_0(980)$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiRho770_0           = bookHistogram1D(15, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\rho^0(770)$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiOmega782           = bookHistogram1D(17, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\omega(782)$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiKStar892Plus       = bookHistogram1D(18, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $K^{*+}(892)$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiKStar892_0         = bookHistogram1D(19, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $K^{*0}(892)$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiPhi1020            = bookHistogram1D(20, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\phi(1020)$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiDStar2010Plus      = bookHistogram1D(21, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $D^{*+}(2010)$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiDStar2007_0        = bookHistogram1D(22, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $D^{*0}(2007)$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiDStar_s2112Plus    = bookHistogram1D(23, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $D^{*+}_s(2112)$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiJPsi1S             = bookHistogram1D(25, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $J/\\psi(1S)$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiF2_1270            = bookHistogram1D(31, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $f_2(1270)$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiP                  = bookHistogram1D(38, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $p$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiLambda             = bookHistogram1D(39, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Lambda$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiSigma0             = bookHistogram1D(40, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Sigma^0$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiXiMinus            = bookHistogram1D(44, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Xi^-$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiDelta1232PlusPlus  = bookHistogram1D(45, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Delta^{++}(1232)$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiSigma1385Minus     = bookHistogram1D(46, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Sigma^-(1385)$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiSigma1385Plus      = bookHistogram1D(47, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Sigma^+(1385)$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiSigma1385PlusMinus = bookHistogram1D(48, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Sigma^\\pm(1385)$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiXi1530_0           = bookHistogram1D(49, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Xi^0(1530)$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiOmegaMinus         = bookHistogram1D(50, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Omega^-$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiLambda_c_Plus      = bookHistogram1D(51, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Lambda_c^+$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiSigma_c_PlusPlus_0 = bookHistogram1D(53, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Sigma_c^{++}, Sigma\\_c0$ multiplicity", "", "Relative multiplicity");
    _hist10MeanMultiLambda1520         = bookHistogram1D(54, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Lambda(1520)$ multiplicity", "", "Relative multiplicity");

    _hist32MeanMultiPi0                = bookHistogram1D( 2, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\pi^0$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiKPlus              = bookHistogram1D( 3, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $K^+$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiK0                 = bookHistogram1D( 4, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $K^0$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiEta                = bookHistogram1D( 5, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\eta$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiEtaPrime           = bookHistogram1D( 6, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\eta'(958)$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiDPlus              = bookHistogram1D( 7, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $D^+$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiD0                 = bookHistogram1D( 8, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $D^0$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiDPlus_s            = bookHistogram1D( 9, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $D^+_s$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiF0_980             = bookHistogram1D(13, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $f_0(980)$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiRho770_0           = bookHistogram1D(15, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\rho^0(770)$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiKStar892Plus       = bookHistogram1D(18, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $K^{*+}(892)$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiKStar892_0         = bookHistogram1D(19, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $K^{*0}(892)$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiPhi1020            = bookHistogram1D(20, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\phi(1020)$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiDStar2010Plus      = bookHistogram1D(21, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $D^{*+}(2010)$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiDStar2007_0        = bookHistogram1D(22, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $D^{*0}(2007)$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiF2_1270            = bookHistogram1D(31, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $f_2(1270)$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiK2Star1430Plus     = bookHistogram1D(33, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $K_2^{*+}(1430)$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiK2Star1430_0       = bookHistogram1D(34, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $K_2^{*0}(1430)$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiP                  = bookHistogram1D(38, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $p$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiLambda             = bookHistogram1D(39, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Lambda$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiXiMinus            = bookHistogram1D(44, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Xi^-$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiSigma1385Minus     = bookHistogram1D(46, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Sigma^-(1385)$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiSigma1385Plus      = bookHistogram1D(47, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Sigma^+(1385)$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiSigma1385PlusMinus = bookHistogram1D(48, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Sigma^\\pm(1385)$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiOmegaMinus         = bookHistogram1D(50, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Omega^-$ multiplicity", "", "Relative multiplicity");
    _hist32MeanMultiLambda_c_Plus      = bookHistogram1D(51, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Lambda_c^+$ multiplicity", "", "Relative multiplicity");

    _hist91MeanMultiPi0                = bookHistogram1D( 2, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\pi^0$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiKPlus              = bookHistogram1D( 3, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $K^+$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiK0                 = bookHistogram1D( 4, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $K^0$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiEta                = bookHistogram1D( 5, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\eta$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiEtaPrime           = bookHistogram1D( 6, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\eta'(958)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiDPlus              = bookHistogram1D( 7, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $D^+$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiD0                 = bookHistogram1D( 8, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $D^0$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiDPlus_s            = bookHistogram1D( 9, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $D^+_s$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiBPlus_B0_d         = bookHistogram1D(10, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $B^+, B^0_d$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiBPlus_u            = bookHistogram1D(11, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $B^+_u$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiB0_s               = bookHistogram1D(12, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $B^0_s$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiF0_980             = bookHistogram1D(13, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $f_0(980)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiA0_980Plus         = bookHistogram1D(14, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $a_0^+(980)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiRho770_0           = bookHistogram1D(15, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\rho^0(770)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiRho770Plus         = bookHistogram1D(16, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\rho^+(770)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiOmega782           = bookHistogram1D(17, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\omega(782)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiKStar892Plus       = bookHistogram1D(18, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $K^{*+}(892)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiKStar892_0         = bookHistogram1D(19, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $K^{*0}(892)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiPhi1020            = bookHistogram1D(20, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\phi(1020)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiDStar2010Plus      = bookHistogram1D(21, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $D^{*+}(2010)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiDStar_s2112Plus    = bookHistogram1D(23, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $D^{*+}_s(2112)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiBStar              = bookHistogram1D(24, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $B^*$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiJPsi1S             = bookHistogram1D(25, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $J/\\psi(1S)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiPsi2S              = bookHistogram1D(26, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\psi(2S)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiUpsilon1S          = bookHistogram1D(27, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Upsilon(1S)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiF1_1285            = bookHistogram1D(28, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $f_1(1285)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiF1_1420            = bookHistogram1D(29, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $f_1(1420)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiChi_c1_3510        = bookHistogram1D(30, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\chi_{c1}(3510)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiF2_1270            = bookHistogram1D(31, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $f_2(1270)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiF2Prime1525        = bookHistogram1D(32, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $f_2'(1525)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiK2Star1430_0       = bookHistogram1D(34, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $K_2^{*0}(1430)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiBStarStar          = bookHistogram1D(35, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $B^{**}$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiDs1Plus            = bookHistogram1D(36, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $D_{s1}^+$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiDs2Plus            = bookHistogram1D(37, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $D_{s2}^+$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiP                  = bookHistogram1D(38, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $p$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiLambda             = bookHistogram1D(39, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Lambda$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiSigma0             = bookHistogram1D(40, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Sigma^0$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiSigmaMinus         = bookHistogram1D(41, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Sigma^-$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiSigmaPlus          = bookHistogram1D(42, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Sigma^+$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiSigmaPlusMinus     = bookHistogram1D(43, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Sigma^\\pm$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiXiMinus            = bookHistogram1D(44, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Xi^-$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiDelta1232PlusPlus  = bookHistogram1D(45, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Delta^{++}(1232)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiSigma1385Minus     = bookHistogram1D(46, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Sigma^-(1385)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiSigma1385Plus      = bookHistogram1D(47, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Sigma^+(1385)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiSigma1385PlusMinus = bookHistogram1D(48, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Sigma^\\pm(1385)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiXi1530_0           = bookHistogram1D(49, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Xi^0(1530)$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiOmegaMinus         = bookHistogram1D(50, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Omega^-$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiLambda_c_Plus      = bookHistogram1D(51, 1, 3, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Lambda_c^+$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiLambda_b_0         = bookHistogram1D(52, 1, 1, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Lambda_b^0$ multiplicity", "", "Relative multiplicity");
    _hist91MeanMultiLambda1520         = bookHistogram1D(54, 1, 2, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Lambda(1520)$ multiplicity", "", "Relative multiplicity");

    _hist165MeanMultiKPlus             = bookHistogram1D( 3, 1, 4, "Ratio (w.r.t. $\\pi^\\pm$) of mean $K^+$ multiplicity", "", "Relative multiplicity");
    _hist165MeanMultiK0                = bookHistogram1D( 4, 1, 4, "Ratio (w.r.t. $\\pi^\\pm$) of mean $K^0$ multiplicity", "", "Relative multiplicity");
    _hist165MeanMultiP                 = bookHistogram1D(38, 1, 4, "Ratio (w.r.t. $\\pi^\\pm$) of mean $p$ multiplicity", "", "Relative multiplicity");
    _hist165MeanMultiLambda            = bookHistogram1D(39, 1, 4, "Ratio (w.r.t. $\\pi^\\pm$) of mean $\\Lambda$ multiplicity", "", "Relative multiplicity");
  }
