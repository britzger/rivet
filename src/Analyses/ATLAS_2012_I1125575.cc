...
namespace Rivet {
  ...
  public:
    ...
    void analyze(const Event& event) {
      ...
      Jets jets_02 = applyProjection<FastJets>(event, "JETS_02").jetsByPt((Cuts::pT > 4.0*GeV) & (Cuts::abseta < 1.5));
      all_jets.push_back(&jets_02);
      Jets jets_04 = applyProjection<FastJets>(event, "JETS_04").jetsByPt((Cuts::pT > 4.0*GeV) & (Cuts::abseta < 1.5));
      all_jets.push_back(&jets_04);
      Jets jets_06 = applyProjection<FastJets>(event, "JETS_06").jetsByPt((Cuts::pT > 4.0*GeV) & (Cuts::abseta < 1.5));
      all_jets.push_back(&jets_06);
      Jets jets_08 = applyProjection<FastJets>(event, "JETS_08").jetsByPt((Cuts::pT > 4.0*GeV) & (Cuts::abseta < 1.5));
      all_jets.push_back(&jets_08);
      Jets jets_10 = applyProjection<FastJets>(event, "JETS_10").jetsByPt((Cuts::pT > 4.0*GeV) & (Cuts::abseta < 1.5));
