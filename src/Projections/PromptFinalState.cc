...
namespace Rivet {
  ...
  PromptFinalState::PromptFinalState(double mineta, double maxeta, double minpt)
    : _acceptMuDecays(false), _acceptTauDecays(false)
  {
    setName("PromptFinalState");
  ...
  PromptFinalState::PromptFinalState(const vector<pair<double, double> >& etaRanges, double minpt)
    : _acceptMuDecays(false), _acceptTauDecays(false)
  {
    setName("PromptFinalState");
